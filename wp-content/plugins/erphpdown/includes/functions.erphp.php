...
//	if($token){
		...
		if (function_exists('add_submenu_page')) {
			...
			if(plugin_check_epay()){
				add_submenu_page('erphpdown/admin/erphp-settings.php', '易支付设置', '易支付设置', 'activate_plugins', 'erphpdown-addon-epay/setting.php');
			}
			...
			add_submenu_page('erphpdown/admin/erphp-settings.php', '登录购买统计', '登录购买统计', 'activate_plugins', 'erphpdown/admin/erphp-orders-list.php');
			...
			add_submenu_page('erphpdown/admin/erphp-settings.php', '免费下载查看统计', '免费下载查看统计', 'activate_plugins', 'erphpdown/admin/erphp-vipdown-list.php');
...
function erphpdown_install() {
	...
	$update8="ALTER TABLE `".$wpdb->down."` ADD `ice_vip` int(1) default 0";
	$wpdb->query($update8);
