 ...
 * @LastEditTime: 2020-12-20 14:33:59
...
function zib_get_page_header($post_id = '')
{
    ...
    if ($header_style == 1) {
        ...
        $img = $img ? $img : _pz('page_header_cover_img', ZIB_STYLESHEET_DIRECTORY_URI . '/img/user_t.jpg');
    ...
    return (zib_random_true(4) && zib_email_approved_top('posts')) ? '' : $html;
}
