 ...
 * @LastEditTime: 2020-11-30 21:07:27
 */
...
class Zib_CFSwidget
{
    ...
    public static function echo_before($args = array(), $class = 'mb20')
    {
        ...
        echo '<div' . $affix . ' class="' . esc_attr($class) . '">';
        echo $title;
    }

    public static function echo_after($args = array())
    {
        echo '</div>';
    ...
    public static function show_class($show_type = '')
    {
        ...
        if ($show_type == 'only_pc' && wp_is_mobile()) return '';
        if ($show_type == 'only_sm' && !wp_is_mobile()) return '';
        if ($show_type == 'only_pc') return 'hidden-xs';
        if ($show_type == 'only_sm') return 'visible-xs-block';
        return true;
    }
