...
Zib_CFSwidget::create('zib_widget_ui_term_card', array(
	...
	'fields'      => array(
		...
		array(
			'id' => 'term_id',
			'title' => '添加分类、专题',
			'placeholder' => '选择并排序需要的分类、专题 | <a href="' . admin_url('edit-tags.php?taxonomy=category') . '">管理分类</a> | <a href="' . admin_url('edit-tags.php?taxonomy=topics') . '">管理专题</a>',
...
function zib_widget_ui_term_card($args, $instance)
{
	...
	if (empty($instance['term_id'][0]) || !$show_class) return;
