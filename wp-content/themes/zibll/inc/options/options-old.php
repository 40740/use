 ...
 * @LastEditTime: 2020-12-10 09:48:40
...
function optionsframework_options()
{
	...
	$options[] = array(
		...
		'id' => 'description_text',
		'type' => '',
		'desc' => '此处设置为全局默认设置，每篇文章或页面均可单独设置'
	);
	$options[] = array(
	...
	$options[] = array(
		'name' => '登录注册',
		'id' => 'text',
		'desc' => __('登陆、注册人机验证功能：', 'zib_language'),
	);
	$options[] = array(
	...
	$options[] = array(
		...
		'question' => '页面也单独设置封面图，如未单独设置则显示此图像',
	...
	$options[] = array(
		...
		'class' => 'op-multicheck',
		'desc' => '热门搜索-置顶搜索词（请使用逗号分割，例如：教程,分享,网络科技）',
		'type' => 'text',
		'std' => '',
	);
	...
	$options[] = array(
		...
		'desc' => __('搜索词关键词 最大保留数量', 'zib_language'),
		'std' => 20,
		'class' => 'op-multicheck',
		'settings' => array(
			'max' => 100,
...
这是一条系统弹窗通知，您可以在后台-主题设置里修改内容',
	...
	$options[] = array(
		...
		'id' => 'footer_t1_m_s',
		'question' => '如果不勾选则仅仅在电脑端显示此板块',
		'type' => "checkbox",
		'std' => false,
		'desc' => __('在移动端显示', 'zib_language')
	);
	$options[] = array(
		'id' => 'footer_t1_img',
		'class' => 'op-multicheck',
...
<a href="https://zibll.com">关于我们</a>',
	...
	$options[] = array(
		'name' => __('板块三', 'zib_language'),
		'id' => 'footer_mini_img_m_s',
		'class' => '',
		'question' => '如果不勾选则仅仅在电脑端此板块',
		'type' => "checkbox",
		'std' => true,
		'desc' => __('在移动端显示')
	);
	...
	$options[] = array(
		...
		'std' => true,
		'desc' => __('开启', 'zib_language'),
		'question' => '开启后则显示首页文章栏目，关闭则首页不显示主文章模块，但仍可通过模块添加',
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		...
		'name' => __('栏目1', 'zib_language'),
		'class' => '',
		'std' => true,
		'desc' => __('显示排序方式按钮', 'zib_language'),
		'type' => 'checkbox'
	);

	$options[] = array(
		'desc' => '文章栏目1：标题',
		'question' => '当未开启其它栏目时，允许为空',
		'class' => 'mini op-multicheck',
		'id' => 'index_list_title',
	...
	$options[] = array(
		'id' => 'option_list_cat_orderby',
		'type' => "checkbox",
		'class' => 'op-multicheck',
		'std' => true,
		'desc' => __('排序方式', 'zib_language')
	);
	...
	$options[] = array(
		'name' => __('排序菜单列表', 'zib_language'),
		'id' => 'option_list_orderby',
		'options' => zib_get_option_list_orderby(),
		'desc' => __('需要显示为菜单的排序方式'),
		'type' => 'multicheck'
	);
	...
	$options[] = array(
		...
		'type' => "checkbox",
		'std' => true,
		'desc' => __('面包屑导航用“首页”替代网站名称', 'zib_language')
	);
	...
	$options[] = array(
		'name' => __('生成海报分享', 'zib_language'),
		'question' => '网站图片如果使用了OSS等云储存，请先设置跨域规则',
		'id' => 'share_img',
		'type' => "checkbox",
		'std' => true,
		'desc' => __('开启（如图片跨域，请确保已经设置好跨域规则）', 'zib_language')
	);
	...
	/////////////////
	$options[] = array(
		'name' => __('码云(gitee)登录', 'zib_language'),
		'id' => 'oauth_gitee_s',
		'std' => false,
		'desc' => __('开启', 'zib_language'),
		'type' => 'checkbox'
	...
	$options[] = array(
		'id' => 'oauth_text',
		'class' => 'op-multicheck',
		'desc' => '接入GitHub登录，申请地址：https://gitee.com/oauth/applications',
		'type' => ""
	);
	$options[] = array(
		'id' => 'oauth_text',
	...
	$options[] = array(
		'id' => 'oauth_text',
		'class' => 'options-notice op-multicheck',
		'desc' => esc_url(home_url('/oauth/gitee/callback')),
		'type' => ""
	);
	...
	$options[] = array(
		'id' => 'oauth_text',
		'class' => 'op-multicheck',
		'desc' => '接入百度登录，申请地址：http://developer.baidu.com/',
		'type' => ""
	);
	$options[] = array(
		'id' => 'oauth_text',
	...
	$options[] = array(
		'id' => 'oauth_text',
		'class' => 'options-notice op-multicheck',
		'desc' => esc_url(home_url('/oauth/baidu/callback')),
		'type' => ""
	);
	...
	$options[] = array(
		'id' => 'oauth_text',
		'class' => 'op-multicheck',
		'desc' => '接入支付宝登录，申请地址：https://open.alipay.com/platform/developerIndex.html',
		'type' => ""
	);
	$options[] = array(
		'id' => 'oauth_text',
		'class' => 'csf-notice op-multicheck',
		'desc' => '注意：由于移动端支付宝登陆只能在支付宝内打开才有效，所以支付宝登陆不会在移动端显示',
		'type' => ""
	);
	$options[] = array(
		'id' => 'oauth_text',
	...
	$options[] = array(
		'id' => 'oauth_text',
		'class' => 'options-notice op-multicheck',
		'desc' => esc_url(home_url('/oauth/alipay/callback')),
		'type' => ""
	);
	...
	$options[] = array(
		'desc' => '支付宝应用ID AppID',
		'class' => 'op-multicheck',
		'id' => 'oauth_alipay_appid',
		'std' => '',
		'type' => 'text'
	);

	$options[] = array(
		'desc' => '支付宝应用私钥 appPrivateKey',
		'class' => 'op-multicheck',
		'id' => 'oauth_alipay_appkrivatekey',
		'std' => '',
		'settings' => array(
			'rows' => 2
		),
	...
	// ======================================================================================================================
	$options[] = array(
		'name' => __('VIP 会员', 'zib_language'),
		'type' => 'heading'
	);

	$options[] = array(
		'id' => 'oauth_text',
		'name' => __('', 'zib_language'),
		'desc' => '开启付费会员功能之前，请先配置好收款接口，确保网站收款正常',
		'type' => ""
	);
	$options[] = array(
		'id' => 'nav_pay_vip',
	...
	$options[] = array(
		...
		'class' => 'op-multicheck',
		'std' => true,
		'desc' => __('在导航栏用户框内显示 开通会员 按钮', 'zib_language'),
		'type' => 'checkbox'
	);
...
<li>VIP用户专属QQ群</li>';
		...
		for ($i = 1; $i <= 4; $i++) {
			...
			$options[] = array(
				...
				'class' => 'op-multicheck mini',
				'std' => $i * 99,
				'desc' => __('执行价（请填写数字金额，单位元，不能为0）', 'zib_language'),
				'type' => 'text'
			);
			$options[] = array(
	...
	$options[] = array(
		...
		'name' => '资源下载',
		'std' => false,
		'question' => '开启后，付费资源的下载按钮就会独立页面显示',
		'desc' => __('独立下载页面', 'zib_language'),
		'type' => 'checkbox'
	);

	$options[] = array(
		'class' => 'mini op-multicheck',
		'id' => 'pay_download_page',
		'std' => get_page_by_title('资源下载')->ID,
		'desc' => '下载页面选择',
		'question' => __('如未创建，请新建空白页面选择：Zibll-资源下载 模板', 'zib_language'),
	...
	$options[] = array(
		'id' => 'default_payment',
		'std' => 'wechat',
		'class' => 'mini-heading inline-block',
		'name' => '快捷支付方式',
		'type' => "radio",
		'options' => array(
	...
	$options[] = array(
		...
		'class' => 'op-multicheck',
		'std' => true,
		'desc' => __('商品详情显示销售数量', 'zib_language'),
		'type' => 'checkbox'
	);

	$options[] = array(
		'name' => __('推广返佣', 'zib_language'),
		'id' => 'pay_rebate_s',
		'class' => '',
		'std' => false,
		'desc' => __('开启', 'zib_language'),
	...
	$options[] = array(
		'id' => 'text',
		'class' => 'mini-heading op-multicheck',
		'html' => '<div class="options-notice"><div class="explain"><p>在下方设置不同用户类型的返佣开启的订单类型和返佣比例，返百之分多少</p>
		<p>请注意以下几点：</p>
		...
		<a href="' . admin_url('users.php') . '">用户管理</a> | <a target="_blank" href="https://www.zibll.com/?s=%E6%8E%A8%E5%B9%BF%E8%BF%94%E4%BD%A3">官方教程</a></div></div>',
		'type' => "html"
	);
	$options[] = array(
		'name' => __('识别模式', 'zib_language'),
		'class' => 'mini-heading',
	...
	$options[] = array(
		'name' => __('返佣规则', 'zib_language'),
		'class' => 'mini-heading',
		'id' => 'text',
		'desc' => __('普通用户推广返佣 开启的订单类型', 'zib_language'),
	);
	$options[] = array(
		'id' => 'pay_rebate_user_s',
		'class' => 'op-multicheck inline-block',
		'std' => false,
		'type' => 'multicheck',
	...
	for ($vi = 1; $vi <= 2; $vi++) {
		$options[] = array(
			'id' => 'text',
			'desc' => __(_pz('pay_user_vip_' . $vi . '_name') . '推广返佣 开启的订单类型', 'zib_language'),
		);
		$options[] = array(
			'id' => 'pay_rebate_user_s_' . $vi,
			'class' => 'op-multicheck inline-block',
			'std' => false,
			'type' => 'multicheck',
			'options' => zibpay_user_rebate_type_options()
		...
		$options[] = array(
			'id' => 'pay_rebate_ratio_vip_' . $vi,
			'desc' => _pz('pay_user_vip_' . $vi . '_name') . '-返佣比例',
			'std' => 10 * $vi + 10,
			'class' => 'op-multicheck',
			'settings' => array(
				'max' => 100,
	...
	$options[] = array(
		'name' => __('返佣文案', 'zib_language'),
		'class' => 'mini-heading',
		'id' => 'pay_rebate_text_desc',
		'desc' => __('一句话简介', 'zib_language'),
		'question' => __('一句话简介，内容不易过多', 'zib_language'),
		'std' => '加入分享计划，获得高额奖励',
		'type' => 'text',
	);
	...
	$options[] = array(
		...
		'desc' => __('返佣详情：标题', 'zib_language'),
		'question' => __('返佣详情介绍的标题', 'zib_language'),
		'std' => '返佣详解',
		'type' => 'text',
	);
	...
	$options[] = array(
		...
		'std' => '<p>此处的推广链接或登陆后任意文章生成的分享链接均有效</p>
...
<p>如需申请更高的返佣比例，或有其它疑问，请联系站长</p>',
		'question' => __('返佣详情介绍，建议为规则介绍或者其他说明（使用HTML代码请注意代码准确性）', 'zib_language'),
		'desc' => __('返佣详情：内容（支持HTML代码）', 'zib_language'),
		'type' => 'textarea',
		'settings' => array(
			'rows' => 4
		),
	...
	$options[] = array(
		...
		'desc' => __('推广让利 标签', 'zib_language'),
		'question' => __('显示在购买模块，推广让利的标签文案', 'zib_language'),
		'std' => '会员推荐 下单再减',
		'type' => 'text',
	);

	$options[] = array(
		'name' => __('用户提现', 'zib_language'),
		'class' => 'mini-heading',
		'id' => 'text',
		'desc' => __('用户在用户中心申请提现后，管理员会收到邮件提醒，管理员进入后台进行处理', 'zib_language'),
	);
	$options[] = array(
		'class' => 'op-multicheck mini',
		'id' => 'pay_rebate_withdraw_lowest_money',
		'desc' => __('最低提现金额', 'zib_language'),
		'question' => __('用户佣金低于此金额时，不能在用户中心提交提现申请。（只能输入数字）', 'zib_language'),
		'std' => '50',
		'type' => 'text',
	);
	...
	$options[] = array(
		...
		'std' => '<div>当佣金积累到50元之后，即可申请提现</div>
<div>申请提现需后台人工处理，一般2-3小时，请耐心等待</div>
<div>如有其它疑问，请联系站长</div>',
		'question' => __('用户申请提现时展示的内容，建议为提现须知等（使用HTML代码请注意代码准确性）', 'zib_language'),
		'desc' => __('提现协议内容（支持HTML代码）', 'zib_language'),
		'type' => 'textarea',
		'settings' => array(
			'rows' => 4
		),
	...
	$options[] = array(
		'name' => __('默认参数', 'zib_language'),
		'id' => 'oauth_text',
		'class' => '',
		'html' => '<div class="options-notice"><div class="explain">在下方配置的参数为文章付费功能的默认值，方便新建文章的设置。最终以文章配置为准</div></div>',
		'type' => "html"
	);

	$options[] = array(
		'id' => 'pay_price_default',
		'desc' => __('执行价 (填0则为免费,填非数字会报错)', 'zib_language'),
		'std' => '0.01',
		'type' => 'text',
		'class' => 'mini op-multicheck'
	);
	...
	$options[] = array(
		...
		'desc' => __('原价 (此价格会显示在执行价格前面，并划掉)', 'zib_language'),
		'std' => '',
		'type' => 'text',
		'class' => 'mini op-multicheck'
	);
	...
	$options[] = array(
		...
		'desc' => __('推广折扣 (通过推广链接购买，额外优惠的金额)', 'zib_language'),
		'question' => __('1.需开启推广返佣功能  2.注意此金不能超过实际购买价，避免出现负数', 'zib_language'),
		'std' => '0',
		'type' => 'text',
		'class' => 'mini op-multicheck' . (_pz('pay_rebate_s') ? '' : ' hide')
	);

	$options[] = array(
		'id' => 'pay_cuont_default',
		'class' => 'mini op-multicheck',
		'desc' => __('销量浮动（必须填数字，已售数量的初始数量）', 'zib_language'),
		'std' => '0',
		'type' => 'text',
	);
	...
	$options[] = array(
		...
		'desc' => __('更多详情 （可插入任意的HTML代码）', 'zib_language'),
		'std' => '',
		'type' => 'textarea',
		'settings' => array(
			'rows' => 3
	...
	$options[] = array(
		...
		'desc' => __('额外隐藏内容 （可插入任意的HTML代码）', 'zib_language'),
		'std' => '',
		'type' => 'textarea',
		'settings' => array(
			'rows' => 3
	...
	$options[] = array(
		...
		'class' => '',
		'html' => '<div class="options-notice"><div class="explain">
		<p>以下收款接口，子比主题仅提供API接入服务，收款平台的可靠性请自行斟酌！</p>
		...
		<a target="_blank" href="https://www.zibll.com/580.html" class="loginbtn">付费功能官方教程</a></div></div>',
		'type' => "html"
	);
	...
	$options[] = array(
		...
		<li>支持PC端扫码支付</li>
		<li>支持移动端H5支付</li>
		回调地址：' . ZIB_STYLESHEET_DIRECTORY_URI . '/zibpay/shop/weixin/return.php</div></div>',
		'type' => "html"
	);
...
*/
	...
	$options[] = array(
		...
		'class' => 'mini-heading',
		'html' => '<div class="options-notice"><div class="explain">
		<p>支付宝官方接口，个人可申请，申请难度低</p>
		<li>支持PC端扫码支付</li>
		<li>如需接入此方式请填写下方参数，反之请留空</li>
		<li>可以同时开启企业支付以及当面付，PC端优先使用当面付</li>
	...
	$options[] = array(
		...
		'id' => 'oauth_text',
		'class' => 'mini-heading',
		'html' => '<div class="options-notice"><div class="explain"><p>迅虎PAY又叫虎皮椒V4，是迅虎网络打造的一个全新的个人收款平台，申请简单，适合个人站长</p>
		<li>微信支付宝支持PC端扫码支付</li>
		<li>微信支持微信内支付、APP跳转支付（H5支付）</li>
		<li>支付宝支持微信内支付、APP跳转支付（H5支付）</li>
		<li>微信内支付请联系客服手动设置返回域名</li>
		开通地址：<a target="_blank" href="https://pay.xunhuweb.com/" class="loginbtn">点击跳转</a></div></div>',
		'type' => "html"
	);
	...
	$options[] = array(
		...
		'id' => 'oauth_text',
		'class' => 'mini-heading',
		'html' => '<div class="options-notice"><div class="explain"><p>PAYJS支持微信、支付宝收款，个人可申请，申请方便，有一定费用</p>
		<li>如果选择了支付宝接口也为PAYJS，请确保您的帐号开通了支付宝收款</li>
		<li>支持微信内自动跳转微信收银台付款，此界面的LOGO调用的是全局桌面图标</li>
		开通地址：<a target="_blank" href="https://payjs.cn/" class="loginbtn">点击跳转</a></div></div>',
		'type' => "html"
	);
	...
	$options[] = array(
		...
		'id' => 'oauth_text',
		'html' => '<div class="options-notice"><div class="explain"><p><b>温馨提醒：</b></p>
		<li>使用自义定代码，需要有一定的代码基础。</li>
		<li>请注意代码的标签闭合</li>
		<li>JS代码请注意错误处理，避免因错误而中断其它函数的执行</li>
		</div></div>',
		'type' => "html"
	);
	...
	$options[] = array(
		...
		'desc' => __(esc_attr('位于</head>之前，这部分代码是在主要内容显示之前加载，通常是CSS样式、自定义的<meta>标签、全站头部JS等需要提前加载的代码'), 'zib_language'),
		'id' => 'headcode',
		'std' => '',
		'type' => 'textarea'
	);
...
*/
	...
	$options[] = array(
		...
		'class' => 'op-multicheck',
		'question' => '开启后在后台编辑用户资料时将不显示无用的多余选项',
		'type' => "checkbox",
		'std' => true,
		'desc' => '关闭后台用户编辑多余的选项'
	);
	...
	$options[] = array(
		...
		'type' => "checkbox",
		'std' => false,
		'desc' => '开启（网站开启全站静态缓存后，如果前台不能弹出登录框，请勾选此项）'
	);
	$options[] = array(
		'name' => '前端页面编辑',
	...
	$options[] = array(
		...
		'desc' => '夜间深色模式下->默认主题',
		'question' => '此为默认设置，古腾堡编辑器中可单独设置主题',
		'type' => 'select',
		'class' => 'op-multicheck mini',
		'std' => 'dracula',
		'options' => array(
	...
	$options[] = array(
		...
		'class' => 'op-multicheck',
		'type' => "checkbox",
		'question' => __('需开启推荐返佣功能，当订单有返佣时则生效', 'zib_language'),
		'std' => true,
		'desc' => '用户支付订单后 向推荐人发送邮件'
	);
	$options[] = array(
