               ...
               <tbody>
                    ...
                    if ($list) {
                         ...
                         foreach ($list as $value) {
                              ...
                              $user_a = $value->user_id ? '<a target="_blank" href="' . get_author_posts_url($value->user_id) . '">' . get_the_author_meta('display_name', $value->user_id) . '</a>' : '未登录购买';
                              ...
                              $rebate_status = '未提现';
                              if ($value->rebate_status == 1) $rebate_status = '已提现';

                              $withdraw = json_encode($value->rebate_detail);
                              echo "<tr>\n";
