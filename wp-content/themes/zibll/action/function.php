 ...
 * @LastEditTime: 2021-01-05 16:39:41
    ...
    switch ($type) {
        case 'email':
            ...
            if (is_email($to)) {
                ...
                $message .= '您的邮箱为：' . $to . "\r\n\r\n";
                $message .= '您的验证码为：';
                $message .= '<p style="font-size:34px;color:#3095f1;"><span style="border-bottom: 1px dashed rgb(204, 204, 204); z-index: 1; position: static;">' . $code . '</span></p>';
