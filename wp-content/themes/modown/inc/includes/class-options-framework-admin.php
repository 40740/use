...
class Options_Framework_Admin {
     ...
     */
	 function options_page() {
		...
		<h2><?php echo esc_html( $menu['page_title'] ); ?><span style="font-size: 14px;">（当前版本 <?php echo 'v'.THEME_VER;?> <a href="javascript:;" id="mbt-theme-check" style="font-size: 12px;">检查更新</a>）</span></h2>
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					...
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '重置设置', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( '确定重置主题设置？', 'theme-textdomain' ) ); ?>' );" style="float:right"/>

					<br><br><p>说明：有任何问题请到<a href="http://www.mobantu.com" target="_blank">模板兔</a>提交工单~</p>
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function active_page() { ?>
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				<form action="options.php" method="post">
				<?php settings_fields( 'optionsframework' ); ?>
				<?php Options_Framework_Interface::optionsframework_active_fields(); /* Settings */ ?>
				<div id="optionsframework-submit">
					<input type="button" id="mbt-theme-active" class="button-primary" value="<?php esc_attr_e( '激活主题', 'theme-textdomain' ); ?>" />
					<p>激活说明：</p>
					<ul>
						<li>1、主题没有域名限制，激活只为确保正版用户的权益！</li>
						<li>2、请勿将激活码告知他人，否则因激活码泄露导致激活异常，我们有权永久禁封您的账号！</li>
						<li>3、模板兔官方网站：www.mobantu.com</li>
						<li>4、激活遇到问题请联系QQ：82708210</li>
					</ul>
					<div class="clear"></div>
				</div>
				</form>
