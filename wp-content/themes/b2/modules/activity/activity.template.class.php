...
class RZR_ACTIVITY_TEMPLATE{
        public $name = '活动',// 搜库资源网 soku.cc   名称
               $slug = 'activity';// 搜库资源网 soku.cc   链接

        public function __construct(){
            add_action( 'seven_activity_home_before', array($this,'swiper'), 0 );// 搜库资源网 soku.cc   幻灯
            add_action( 'seven_activity_home_list_before', array($this,'activity_list_before'), 0 );// 搜库资源网 soku.cc   活动筛选
            add_action( 'seven_activity_home_list', array($this,'activity_list'), 0 );// 搜库资源网 soku.cc   活动列表
            add_action( 'seven_activity_home_sidebar', array($this,'sidebar'), 0 );// 搜库资源网 soku.cc   活动侧边栏
            add_action( 'seven_activity_single_top', array($this,'single_top'), 0 );// 搜库资源网 soku.cc   活动内页顶部
            add_action( 'seven_activity_single_content', array($this,'single_content'), 0 );// 搜库资源网 soku.cc   活动内页content
            add_filter( 'pre_get_posts', array($this,'get_posts') );// 搜库资源网 soku.cc   筛选
            add_filter( 'zrz_display_links_filter', array($this,'public_activity_button') );// 搜库资源网 soku.cc   增加一个发布项
        }
