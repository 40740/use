...
function zrz_bbp_current_user_can_access_create_topic_form() {
	...
	} elseif ( ( bbp_is_single_forum() || is_page() || is_single() || zrz_get_page(false,'newtopic')) && bbp_is_forum_open() ) {
...
// 搜库资源网 soku.cc   重定义编辑提示样式
function zrz_get_topic_revision_log( $topic_id = 0 ) {
	// 搜库资源网 soku.cc    Create necessary variables
	...
	// 搜库资源网 soku.cc    Loop through revisions
...
function zrz_bbp_forum_info(){
	...
	// 搜库资源网 soku.cc    <div class="fl">'.get_avatar(1,50).'</div>
