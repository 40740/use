										...
										echo '<li class="fd pd10 shop-list-li shop-g">
											...
											<div class="shop-list-content">
												...
												<div class="shop-normal-meta fs12 gray clearfix">
													<div class="fl">
														<span>总数：<b>'.zrz_get_shop_count($post_id,'total').'</b> <span class="dot"></span>'.(current_user_can('delete_users') ? '<b>'.zrz_get_shop_count($post_id,'sell').'</b>' : '').'</span>
													</div>
