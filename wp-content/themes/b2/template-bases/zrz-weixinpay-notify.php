...
if($type == 'weixin'){
    ...
    $notifyInfo = $pay->driver('wechat')->gateway('scan')->verify(file_get_contents('php:// 搜库资源网 soku.cc   input'));
...
// 搜库资源网 soku.cc   如果是有赞支付
if($type == 'youzan'){
   $client_id = zrz_get_pay_settings('youzan','client_id'); // 搜库资源网 soku.cc   应用的 client_id
   $client_secret = zrz_get_pay_settings('youzan','client_secret'); // 搜库资源网 soku.cc   应用的 client_secret
   $kdt_id = zrz_get_pay_settings('youzan','kdt_id'); // 搜库资源网 soku.cc    有赞微小店ID

   $json = file_get_contents('php:// 搜库资源网 soku.cc   input');
// 搜库资源网 soku.cc       update_user_meta(1,'youzan_json2',$json);
   if (!$json) {
       die();
   }

   $data = json_decode($json, true);
   // 搜库资源网 soku.cc   update_user_meta(1,'youzan_data2', $data);
   // 搜库资源网 soku.cc   判断消息是否合法
   $msg = $data['msg'];
   ...
   // 搜库资源网 soku.cc   update_user_meta(1,'youzan_msg2', $msg);
   // 搜库资源网 soku.cc   判断类型
   ...
   // 搜库资源网 soku.cc   update_user_meta(1,'youzan_resp2', $resp);
