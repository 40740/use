...
<div class="wrap">
	...
	<form method="post">
        ...
        $option->table( array(
            ...
            // 搜库资源网 soku.cc            'th' =>'是否启用文章内部图片评论功能？',
            // 搜库资源网 soku.cc            'after' => '<p>'.__('后台编辑器不支持此选项','zrz').'</p>',
            // 搜库资源网 soku.cc            'key' => 'zrz_post_img_comment',
            // 搜库资源网 soku.cc            'value' => array(
            // 搜库资源网 soku.cc                'default' => array(intval(get_option('zrz_post_img_comment',1))),
            // 搜库资源网 soku.cc                'option' => array(
            // 搜库资源网 soku.cc                    1 => __( '启用', 'zrz' ),
