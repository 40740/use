	...
	<form method="post">
            ...
            array(
                ...
                'value' => array(
                    ...
                    'option' => array(
                        ...
                        // 搜库资源网 soku.cc   'qiniu' => __( '七牛云', 'ziranzhi2' ),
                        'aliyun' => __( '阿里云OSS', 'ziranzhi2' ),
                        // 搜库资源网 soku.cc   'upyun' => __( '又拍云', 'ziranzhi2' ),
                    )
                )
            ),
        ));
        ...
        $option->table( array(
            array(
                ...
                'after'=>__('<p>如果需要回源请设置，如果不需要，请留空！比如<code>https:// 搜库资源网 soku.cc   status.7b2.com</code></p>','ziranzhi2'),
                'key' => 'huiyuan',
                'value' => $huiyuan
            )
        ));
        ...
        $option->table( array(
            ...
            array(
                ...
                'after'=>__('<p>可以是七牛云的默认域名，建议自己绑定的域名。（支持https）</p>比如：<p><code>http:// 搜库资源网 soku.cc   xxxx.bkt.clouddn.com</code></p><p><code>http:// 搜库资源网 soku.cc   images.my-domain.com</code></p>','ziranzhi2'),
                'key' => 'qiniu_host',
                'value' => $qiniu['host']
            ),
        ));
        ...
        $option->table( array(
            ...
            array(
                ...
                'after'=>__('<p>可以是OSS的默认域名，也可以是自己绑定的域名。（支持https）</p>比如：<p><code>http:// 搜库资源网 soku.cc   my-bucket.oss-cn-shenzhen.aliyuncs.com</code></p><p><code>http:// 搜库资源网 soku.cc   status.your-domain.com</code></p>','ziranzhi2'),
                'key' => 'aliyun_host',
                'value' => $aliyun['host']
            ),
            array(
            ...
            array(
                ...
                'after'=>__('<p>OSS的水印参数，文档请参考：<a target="_blank" href="https:// 搜库资源网 soku.cc   help.aliyun.com/document_detail/44957.html?spm=a2c4g.11186623.6.1027.xpVkuf">OSS水印文档</a><br>例如：<code>/watermark,image_cGFuZGEucG5nP3gtb3NzLXByb2Nlc3M9aW1hZ2UvcmVzaXplLFBfMzA,t_90,g_se,x_10,y_10</code>，不设置水印请留空</p>','ziranzhi2'),
                'key' => 'watermark',
        ...
        $option->table( array(
			...
			array(
                'type' => 'input',
                'th' => __('绑定的域名','ziranzhi2'),
                'after'=>__('<p>可以是又拍云的默认域名，建议自己绑定的域名。（支持https）</p>比如：<p><code>http:// 搜库资源网 soku.cc   xxx.b0.upaiyun.com</code></p><p><code>http:// 搜库资源网 soku.cc   www.my-domain.com</code></p>','ziranzhi2'),
                'key' => 'upyun_host',
                'value' => $upyun['host']
            ),
        ));
