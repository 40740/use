		...
		<?php
			...
			$option->table( array(
				array(
					...
					'after' => '<p>'.__('请输入您在 <a href="http:// 搜库资源网 soku.cc   7b2.com">7b2.com</a> 用户会员号，也就是第几号会员。','ziranzhi2').'</p><p>查看方法：进入您的个人主页中查看。</p>',
					'key' => 'zrz_theme_id',
...
<style>
	...
	<ol>
		...
		<ol>
            ...
            <li>
                推荐使用阿里云OSS图片储存服务，这样可以大幅度减少服务器的压力，也会给用户提供更好的访问体验。<a target="_blank" href="https:// 搜库资源网 soku.cc   promotion.aliyun.com/ntms/act/ambassador/sharetouser.html?userCode=jlp9zsx5">阿里云</a>
            </li>
			<li>
