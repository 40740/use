...
if(isset($_POST['action']) && sanitize_text_field($_POST['action'])=='restart'){
    ...
    $options = array(
        'zrz_credit_signup'=>trim_value($_POST['zrz_credit_signup']),// 搜库资源网 soku.cc   注册奖励
        'zrz_credit_comment'=>trim_value($_POST['zrz_credit_comment']),// 搜库资源网 soku.cc   发表评论奖励
        'zrz_credit_post'=>trim_value($_POST['zrz_credit_post']),// 搜库资源网 soku.cc   投稿奖励
        'zrz_credit_post_commented'=>trim_value($_POST['zrz_credit_post_commented']),// 搜库资源网 soku.cc   文章被评论或评论被回复或帖子被回复得分
        'zrz_credit_comment_vote_up'=>trim_value($_POST['zrz_credit_comment_vote_up']),// 搜库资源网 soku.cc   评论点赞
        'zrz_credit_comment_vote_up_deduct'=>trim_value($_POST['zrz_credit_comment_vote_up_deduct']),// 搜库资源网 soku.cc   评论被踩
        // 搜库资源网 soku.cc   'zrz_credit_love'=>$_POST['zrz_credit_love'],// 搜库资源网 soku.cc   文章点赞（收藏）奖励
        'zrz_credit_followed'=>trim_value($_POST['zrz_credit_followed']),// 搜库资源网 soku.cc   被关注
        'zrz_credit_follow'=>trim_value($_POST['zrz_credit_follow']),// 搜库资源网 soku.cc   被关注
        // 搜库资源网 soku.cc   'zrz_rec_credit'=>$_POST['zrz_rec_credit'],// 搜库资源网 soku.cc   每天可得积分的次数
        'zrz_credit_mission'=>trim_value($_POST['zrz_credit_mission']),// 搜库资源网 soku.cc   签到奖励
        'zrz_credit_reply'=>trim_value($_POST['zrz_credit_reply']),// 搜库资源网 soku.cc   回复帖子
        'zrz_credit_topic'=>trim_value($_POST['zrz_credit_topic']),// 搜库资源网 soku.cc   创建一个帖子
        'zrz_credit_pps'=>trim_value($_POST['zrz_credit_pps']),// 搜库资源网 soku.cc   发表一个冒泡
        'zrz_credit_labs'=>trim_value($_POST['zrz_credit_labs']),// 搜库资源网 soku.cc   发表一个研究
        'zrz_credit_rmb'=>trim_value($_POST['zrz_credit_rmb']),// 搜库资源网 soku.cc   人民币兑换积分比例
        'zrz_credit_name'=>trim_value($_POST['zrz_credit_name']),// 搜库资源网 soku.cc   积分名称
        'zrz_credit_display'=>$_POST['zrz_credit_display'],// 搜库资源网 soku.cc   显示类型
        'zrz_credit_invitation'=>trim_value($_POST['zrz_credit_invitation']),// 搜库资源网 soku.cc   积分名称
        'zrz_credit_be_invitation'=>trim_value($_POST['zrz_credit_be_invitation']),// 搜库资源网 soku.cc   显示类型
...
<div class="wrap">
	...
	<form method="post">
		...
		$option->table( array(
            ...
            // 搜库资源网 soku.cc    array(
            // 搜库资源网 soku.cc        'type' => 'input',
            // 搜库资源网 soku.cc        'th' => __('文章被收藏','ziranzhi2'),
            // 搜库资源网 soku.cc        'key' => 'zrz_credit_love',
            // 搜库资源网 soku.cc        'after' => '<p class="description">奖励对象：文章作者。默认60分。</p>',
            // 搜库资源网 soku.cc        'value' => zrz_get_credit_settings('zrz_credit_love')
            // 搜库资源网 soku.cc    ),
			array(
				'type' => 'input',
            ...
            // 搜库资源网 soku.cc    array(
            // 搜库资源网 soku.cc        'type' => 'input',
            // 搜库资源网 soku.cc        'th' => __('每天可得积分的次数','ziranzhi2'),
            // 搜库资源网 soku.cc        'key' => 'zrz_rec_credit',
            // 搜库资源网 soku.cc        'after' => '<p class="description">超过则不再增加积分。</p>',
            // 搜库资源网 soku.cc        'value' => zrz_get_credit_settings('zrz_rec_credit')
            // 搜库资源网 soku.cc    ),
            array(
				'type' => 'input',
