...
function zrz_options_display_page(){
  ...
  if( isset($_POST['action']) && sanitize_text_field($_POST['action'])=='update' && wp_verify_nonce( trim($_POST['_wpnonce']), 'check-nonce' ) ) :
    $options = array(
        ...
        'single'=>array(
            'reaction'=>$_POST['reaction'],// 搜库资源网 soku.cc   表情投票
            'long_weibo'=>$_POST['long_weibo'],// 搜库资源网 soku.cc   封面
            'navigation'=>$_POST['navigation'],// 搜库资源网 soku.cc   上一篇，下一篇
            'ds'=>$_POST['ds']// 搜库资源网 soku.cc   上一篇，下一篇
        ),
        'hello'=>$_POST['hello'],
	...
	<form method="post">
        ...
        $option->table( array(
            ...
            array(
                ...
                'after' => '<p>格式为 <code>活动的文章ID<span style="color:red">|</span>封面图片地址</code> ，活动的文章ID和所对应的封面图片用<span style="color:red">|</span>隔开，如果不设置封面，请在图片网址的地方写0，例如<code>1223|0</code>，每组占一行，最多支持6个，排序与此设置相同。图片请在 <a target="_blank" href="'.home_url('/wp-admin/media-new.php').'">媒体中心</a> 上传。</p><p>例如：<p><code>123|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code><br>
                <code>456|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code><br>
                <code>3434|0</code><br>
                <code>2344|0</code><br>
                <code>2334|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code><br>
                <code>5556|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code></p>',
        ...
        $option->table( array(
            ...
            array(
                ...
                'after' => '<p>格式为 <code>文章ID<span style="color:red">|</span>封面图片地址</code> ，文章ID和所对应的封面图片用<span style="color:red">|</span>隔开，如果不设置封面，请在图片网址的地方写0，例如<code>1223|0</code>，每组占一行，排序与此设置相同。图片可以在 <a target="_blank" href="'.home_url('/wp-admin/media-new.php').'">媒体中心</a> 上传。</p><p>例如：<p><code>123|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code><br>
                <code>456|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code><br>
                <code>3434|0</code><br>
                <code>2344|0</code><br>
                <code>2334|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code><br>
        ...
        $option->table( array(
            ...
            array(
                ...
                'after' => '<p>格式为 <code>专题ID<span style="color:red">|</span>封面图片地址</code> ，专题ID和所对应的封面图片用<span style="color:red">|</span>隔开，每组占一行，最多支持6个，排序与此设置相同。图片请在 <a target="_blank" href="'.home_url('/wp-admin/media-new.php').'">媒体中心</a> 上传。</p><p>例如：<p><code>123|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code><br>
                <code>456|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code><br>
                <code>3434|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code><br>
                <code>2344|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code><br>
                <code>2334|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code><br>
                <code>5556|https:// 搜库资源网 soku.cc   xxx.com/wp-content/uploads/xxx.jpg</code></p>',
