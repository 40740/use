...
function zrz_options_writing_page(){
    ...
    if( isset($_POST['action']) && sanitize_text_field($_POST['action'])=='update' && wp_verify_nonce( trim($_POST['_wpnonce']), 'check-nonce' ) ) :
        ...
        $options = array(
                'cat'=>isset($_POST['cat']) && !empty($_POST['cat']) ? $_POST['cat'] : array(1),// 搜库资源网 soku.cc   允许投稿的分类
                'cat_more'=>$_POST['cat_more'],// 搜库资源网 soku.cc   允许投稿的分类
                'min_strlen'=>trim_value($_POST['min_strlen']),// 搜库资源网 soku.cc   投稿最少字数
                'max_strlen'=>trim_value($_POST['max_strlen']),// 搜库资源网 soku.cc   投稿最多字数
                'post_format'=>$_POST['post_format'],// 搜库资源网 soku.cc   是否允许用户选择文章形式
                'tag_count'=>trim_value($_POST['tag_count']),// 搜库资源网 soku.cc   允许输入的标签最大数
                'custom_tags'=>$custom_tags,// 搜库资源网 soku.cc   管理员自定义的标签
                'video_size'=>trim_value($_POST['video_size']),// 搜库资源网 soku.cc   允许上传的视频体积
                'status'=>$_POST['status'],// 搜库资源网 soku.cc   投稿后的状态
                'edit_time'=>trim_value($_POST['edit_time']),// 搜库资源网 soku.cc   多长时间内允许编辑
                'related_chose'=>$_POST['related_chose'],// 搜库资源网 soku.cc   是否允许选择相关文章
                'labs_status'=>$_POST['labs_status'],// 搜库资源网 soku.cc   投稿后的状态
                'labs_edit_time'=>trim_value($_POST['labs_edit_time']),// 搜库资源网 soku.cc   多长时间内允许编辑
                'auto_draft'=>$_POST['auto_draft'],// 搜库资源网 soku.cc   多长时间内允许编辑
                // 搜库资源网 soku.cc    'allow_fj'=>$_POST['allow_fj'],
                // 搜库资源网 soku.cc    'allow_video'=>$_POST['allow_video'],
                // 搜库资源网 soku.cc    'fj_open'=>$_POST['fj_open']
            );
...
<div class="wrap">
	...
	<form method="post">
		...
		$option->table( array(
            ...
            // 搜库资源网 soku.cc        'th' => __('是否允许用户上传视频？','ziranzhi2'),
            // 搜库资源网 soku.cc        'key' => 'allow_video',
            // 搜库资源网 soku.cc        'value' => array(
            // 搜库资源网 soku.cc            'default' => array(zrz_get_writing_settings('allow_video')),
            // 搜库资源网 soku.cc            'option' => array(
            // 搜库资源网 soku.cc                1 => __( '允许', 'ziranzhi2' ),
            // 搜库资源网 soku.cc                0 => __( '禁止', 'ziranzhi2' )
            // 搜库资源网 soku.cc            )
            // 搜库资源网 soku.cc        )
            // 搜库资源网 soku.cc    ),
            // 搜库资源网 soku.cc    array(
            // 搜库资源网 soku.cc        'type' => 'select',
            // 搜库资源网 soku.cc        'th' => __('是否允许用户上传附件？','ziranzhi2'),
            // 搜库资源网 soku.cc        'key' => 'allow_fj',
            // 搜库资源网 soku.cc        'value' => array(
            // 搜库资源网 soku.cc            'default' => array(zrz_get_writing_settings('allow_fj')),
            // 搜库资源网 soku.cc            'option' => array(
            // 搜库资源网 soku.cc                1 => __( '允许', 'ziranzhi2' ),
            // 搜库资源网 soku.cc                0 => __( '禁止', 'ziranzhi2' )
            // 搜库资源网 soku.cc            )
            ...
            // 搜库资源网 soku.cc    array(
            // 搜库资源网 soku.cc        'type' => 'select',
            // 搜库资源网 soku.cc        'th' => __('附件下载新窗口打开？','ziranzhi2'),
            // 搜库资源网 soku.cc        'key' => 'fj_open',
            // 搜库资源网 soku.cc        'value' => array(
            // 搜库资源网 soku.cc            'default' => array(zrz_get_writing_settings('fj_open')),
            // 搜库资源网 soku.cc            'option' => array(
            // 搜库资源网 soku.cc                1 => __( '直接下载', 'ziranzhi2' ),
            // 搜库资源网 soku.cc                0 => __( '新窗口打开下载', 'ziranzhi2' )
            // 搜库资源网 soku.cc            )
            // 搜库资源网 soku.cc        )
            // 搜库资源网 soku.cc    ),
		) );
