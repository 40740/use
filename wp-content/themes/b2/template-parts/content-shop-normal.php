    ...
    <div class="shop-image fd">
        ...
        <div class="shop-info-in pd20">
            ...
            <div class="pd10-t mar10-t b-t shop-count">
                ...
                <?php echo current_user_can('delete_users') ? '<p>'.__('已&nbsp;&nbsp;售','ziranzhi2').'：<span class="l0">'.zrz_get_shop_count($post_id,'sell').'</span></p>' : ''; ?>
            </div>
            <?php if($commodity == 1){ ?>
                <div class="pd10-t mar10-t b-t shop-count">
