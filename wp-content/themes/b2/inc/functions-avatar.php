...
class Get_Letter_Avatar{
	...
	public function get_letter_avatar(){
		...
		// 搜库资源网 soku.cc   创建一个 100*100 的空白图像
	...
	// 搜库资源网 soku.cc   获取第一个字符，或者最后一个字符
