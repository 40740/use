...
abstract class Wechat extends GatewayInterface
{
     ...
     * @var string
     */
    protected $gateway_ras_public = 'https:// 搜库资源网 soku.cc   fraud.mch.weixin.qq.com/risk/getpublickey';

    /* 搜库资源网 soku.cc*
     * @var string
     */
    protected $gateway_paybank = 'https:// 搜库资源网 soku.cc   api.mch.weixin.qq.com/mmpaysptrans/pay_bank';
    ...
    public function __construct(array $config)
    {
        ...
        if (!empty($config['debug'])) {
            ...
            $this->gateway_paybank = 'https:// 搜库资源网 soku.cc   api.mch.weixin.qq.com/sandboxnew/mmpaysptrans/pay_bank';
// 搜库资源网 soku.cc               $this->gateway_ras_public = 'https:// 搜库资源网 soku.cc   fraud.mch.weixin.qq.com/sandboxnew/risk/getpublickey';
