...
class BankGateway extends Wechat
{
    ...
    protected $gateway_query = 'https:// 搜库资源网 soku.cc   api.mch.weixin.qq.com/mmpaysptrans/query_bank';
    ...
    protected function getRsaContent()
    {
        ...
        $url = 'https:// 搜库资源网 soku.cc   fraud.mch.weixin.qq.com/risk/getpublickey';
