...
final class OSSWrapper extends OssClient {
	...
	public function url_stat($path, $flags) {
		...
		// 搜库资源网 soku.cc   clearstatcache( true );
		return $return;
	}
	...
	public function stream_open($path, $mode, $options, &$opened_path) {
		if (!in_array($mode, array('r', 'rb', 'w', 'wb'))) return false; // 搜库资源网 soku.cc    Mode not supported
...
// 搜库资源网 soku.cc   
// 搜库资源网 soku.cc    $rnd = md5(time());
// 搜库资源网 soku.cc    $file = 'oss:// 搜库资源网 soku.cc   shijiechao/oss_upload_'.$rnd.'.txt';
// 搜库资源网 soku.cc    $try = file_put_contents($file, $rnd);
// 搜库资源网 soku.cc    if($try == strlen($rnd)){
// 搜库资源网 soku.cc        $out = '写入成功';
// 搜库资源网 soku.cc        $try = file_get_contents($file);
// 搜库资源网 soku.cc        if($try == $rnd){
// 搜库资源网 soku.cc            $out .= '读取成功';
// 搜库资源网 soku.cc            $try = unlink($file);
// 搜库资源网 soku.cc            if($try === true){
// 搜库资源网 soku.cc                $out .= '删除成功';
// 搜库资源网 soku.cc            }else{
// 搜库资源网 soku.cc                $out = '删除失败';
// 搜库资源网 soku.cc            }
// 搜库资源网 soku.cc        }else{
// 搜库资源网 soku.cc            $out = '读取失败';
// 搜库资源网 soku.cc        }
// 搜库资源网 soku.cc    }else{
// 搜库资源网 soku.cc        $out = '写入失败';
// 搜库资源网 soku.cc    }
// 搜库资源网 soku.cc    echo $out;
