...
class Payjs
{
    private $url = 'https:// 搜库资源网 soku.cc   payjs.cn/api/native';
    private $key;            // 搜库资源网 soku.cc    填写通信密钥
    private $mchid;          // 搜库资源网 soku.cc    特写商户号
  	private $inweixin;
    private $callback;
    ...
    public function pay(){
        ...
        if($this->inweixin){
            return 'https:// 搜库资源网 soku.cc   payjs.cn/api/cashier?' . http_build_query($data);
        }else{
