<?php
// 搜库资源网 soku.cc   视频网站截图获取
// 搜库资源网 soku.cc   版本：V1.0
// 搜库资源网 soku.cc   开发者：顾问
// 搜库资源网 soku.cc   官方网站：https:// 搜库资源网 soku.cc   www.dounai0.com
// 搜库资源网 soku.cc   502网站无法访问
...
function zrz_get_video_thumb($_url){
    ...
    if($url['host']=="v.youku.com"){
    	...
    	$youkupic = json_decode(zrz_get_url_content("https:// 搜库资源网 soku.cc   api.youku.com/videos/show.json?client_id=58263aed0903a6d8&video_id=$youkuid"),true);
    ...
    elseif($url['host']=="new-play.tudou.com" || $url['host']=="video.tudou.com"){
    	...
    	$tudoupic = json_decode(zrz_get_url_content("https:// 搜库资源网 soku.cc   api.youku.com/videos/show.json?client_id=58263aed0903a6d8&video_id=$tudouid"),true);
        $title = $youkupic['title'];
    ...
    elseif($url['host']=="v.qq.com"){
    	...
    	preg_match_all("|\"pic_640_360\"\:\"(.*)\",\"c_title_segment|U", $qqidurl, $regs2);// 搜库资源网 soku.cc   获取网站大图
    ...
    elseif($url['host']=="www.iqiyi.com"){
    	...
    	preg_match_all("|<meta itemprop=\"image\" content=\"(.*)\"\/>|U", $qiyiidurl, $regs2);// 搜库资源网 soku.cc   获取网站大图
    ...
    elseif($url['host']=="www.bilibili.com"){
    	...
    	preg_match_all("|<meta data-vue-meta=\"true\" itemprop=\"image\" content=\"(.*)\"\/>|U", $biliidurl, $regs2);// 搜库资源网 soku.cc   获取网站大图
    ...
    elseif($url['host']=="www.acfun.cn" || $url['host']=="v.hapame.com"){
    	...
    	preg_match_all("|coverImage\":\"(.*)\",\"|U", $acfunidurl, $regs2);// 搜库资源网 soku.cc   获取网站大图
    ...
    elseif($url['host']=="www.miaopai.com"){
    	...
    	preg_match_all("|\"poster\":\"(.*)\"|U", $miaopaiidurl, $regs2);// 搜库资源网 soku.cc   获取网站大图
        preg_match("/<title>(.+)<\/title>/i", $miaopaiidurl, $matches);
    	$bigThumbnail = $regs2[1][0];
        $title = $matches[1];
    }
    // 搜库资源网 soku.cc   无效地址返回
    else{
    	return false;
    }
