...
// 搜库资源网 soku.cc    将关键词和描述输出在wp_head区域
...
<meta property="og:image" content="'.$logo.'" />';
	    ...
	    $cat = isset(get_queried_object()->term_id) ? get_queried_object()->term_id : 0;
