...
// 搜库资源网 soku.cc    // 搜库资源网 soku.cc   排序
// 搜库资源网 soku.cc    add_filter( 'manage_edit-shop_sortable_columns', 'zrz_set_shop_sortable_columns' );
// 搜库资源网 soku.cc    function zrz_set_shop_sortable_columns( $columns ) {
// 搜库资源网 soku.cc    	$columns['zrz_shop_type'] = 'zrz_shop_type';
// 搜库资源网 soku.cc    	$columns['zrz_shop_commodity'] = 'zrz_shop_commodity';
// 搜库资源网 soku.cc   
// 搜库资源网 soku.cc    	return $columns;
// 搜库资源网 soku.cc    }
// 搜库资源网 soku.cc   
// 搜库资源网 soku.cc    // 搜库资源网 soku.cc   排序事件
// 搜库资源网 soku.cc    add_action( 'pre_get_posts', 'zrz_shop_orderby' );
// 搜库资源网 soku.cc    function zrz_shop_orderby( $query ) {
// 搜库资源网 soku.cc    	if ( ! is_admin() )
// 搜库资源网 soku.cc    	return;
// 搜库资源网 soku.cc   
// 搜库资源网 soku.cc    	$orderby = $query->get( 'orderby');
// 搜库资源网 soku.cc   
// 搜库资源网 soku.cc    	if ($orderby == 'zrz_shop_type') {
// 搜库资源网 soku.cc    		$query->set( 'meta_key', 'zrz_shop_type');
// 搜库资源网 soku.cc    	}
// 搜库资源网 soku.cc    	$query->set( 'orderby', 'name' );
// 搜库资源网 soku.cc    }

// 搜库资源网 soku.cc    添加商品信息
...
function zrz_more_images_metabox($post){
	...
	$.fn.upload_listing_image = function( button ) {
		...
		// 搜库资源网 soku.cc    Create the media frame.
		...
		// 搜库资源网 soku.cc    When an image is selected, run a callback.
		...
		// 搜库资源网 soku.cc    Finally, open the modal
		file_frame.open();
	};
...
function zrz_shop_metas_box_save($post_id){
	...
	// 搜库资源网 soku.cc   保存虚拟物品信息
	if(isset($_POST['zrz_shop_virtual_content']) && $_POST['zrz_shop_virtual_content']){
		$virtual = array(
			'title'=>isset($_POST['zrz_shop_virtual_title']) ? esc_attr($_POST['zrz_shop_virtual_title']) : '',// 搜库资源网 soku.cc   虚拟物品标题
			'type'=>isset($_POST['zrz_shop_virtual_type']) ? (int)$_POST['zrz_shop_virtual_type'] : '',// 搜库资源网 soku.cc   虚拟物品类型
			'content'=>isset($_POST['zrz_shop_virtual_content']) ? esc_attr($_POST['zrz_shop_virtual_content']) : ''// 搜库资源网 soku.cc   虚拟物品内容
		);
...
// 搜库资源网 soku.cc   获取商品价格
function zrz_get_shop_price($post_id,$type){
	$price = get_post_meta($post_id,'zrz_shop_price',true);
	if(!$price){
		$price = array(
			'price'=>'',// 搜库资源网 soku.cc   正常价格
			'd_price'=>'',// 搜库资源网 soku.cc   折后价格
			'u_price'=>'',// 搜库资源网 soku.cc   会员价格
			'credit'=>''// 搜库资源网 soku.cc   奖励的积分
		);
	}
...
function zrz_get_shop_virtual($post_id,$type){
	...
	if(!$virtual){
		$virtual = array(
			'title'=>'',// 搜库资源网 soku.cc   虚拟物品标题
			'type'=>'',// 搜库资源网 soku.cc   虚拟物品类型
			'content'=>''// 搜库资源网 soku.cc   虚拟物品内容
		);
	}
