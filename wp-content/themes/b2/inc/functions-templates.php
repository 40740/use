<?php
// 搜库资源网 soku.cc   主题使用的钩子
// 搜库资源网 soku.cc   header
add_action( 'header_7b2', 'header_announcement_7b2', 0 );// 搜库资源网 soku.cc   顶部公告

// 搜库资源网 soku.cc   menu
add_action( 'header_menu_7b2', 'header_menu_mobile_button_left_7b2', 0 );// 搜库资源网 soku.cc   移动菜单左侧按钮
add_action( 'header_menu_7b2', 'header_menu_logo_7b2', 10 );// 搜库资源网 soku.cc   logo
add_action( 'header_menu_7b2', 'header_menu_mobile_top_7b2', 30 );// 搜库资源网 soku.cc   移动菜单顶部logo和搜索框
add_action( 'header_menu_7b2', 'header_top_menu_7b2', 40 );// 搜库资源网 soku.cc   菜单

// 搜库资源网 soku.cc   首页
add_action( 'home_before_7b2', 'home_big_img_7b2', 0 );// 搜库资源网 soku.cc   首页背景图片
add_action( 'home_before_7b2', 'home_carousel_7b2', 10 );// 搜库资源网 soku.cc   首页幻灯
add_action( 'home_before_7b2', 'home_mission_7b2', 20 );// 搜库资源网 soku.cc   移动端首页签到
add_action( 'home_before_7b2', 'home_collection_7b2', 30 );// 搜库资源网 soku.cc   首页专题

add_action( 'home_loop_before_7b2', 'home_menu_7b2', 0 );// 搜库资源网 soku.cc   首页菜单

add_action( 'home_loop_middle_7b2', 'home_labs_7b2', 0 );// 搜库资源网 soku.cc   首页研究所

// 搜库资源网 soku.cc   content
add_action( 'content_after_7b2', 'footer_toolbar_7b2', 0 );// 搜库资源网 soku.cc   工具条

// 搜库资源网 soku.cc   footer
add_action( 'footer_content_7b2', 'footer_links_7b2', 0 );// 搜库资源网 soku.cc   工具条
add_action( 'footer_content_7b2', 'footer_copy_7b2', 10 );// 搜库资源网 soku.cc   底部版权

add_action( 'footer_before_7b2', 'footer_tools_7b2',  0);// 搜库资源网 soku.cc   登陆组件

add_action( 'footer_after_7b2','weixin_share_fn',  0);// 搜库资源网 soku.cc   登陆组件

// 搜库资源网 soku.cc   顶部菜单移动端
        ...
        ?>
            <div id="go-top" class="go-top" :style="'z-index:'+index">
                ...
                ?>
                    <template v-cloak>
                        <?php
                            if(zrz_get_theme_settings('theme_style_select') && !zrz_is_custom_tax('bbpress') && !zrz_is_custom_tax('collection') && !is_single() && !is_page() && !zrz_get_page(false,'links') && !is_post_type_archive('shop')){ ?>
...
if ( ! function_exists( 'footer_copy_7b2' ) ) {
    function footer_copy_7b2(){
        ...
        <p class="ipc"><a href="http:// 搜库资源网 soku.cc   beian.miit.gov.cn" target="_blank" rel="nofollow">'.$ipc.'</a></p>';
...
if(!function_exists('weixin_share_fn')){
    ...
    <script>
         wx.config ({
                debug : false,    // 搜库资源网 soku.cc    true:调试时候弹窗
                appId : '<?php echo $wx_data['appId']; ?>',  // 搜库资源网 soku.cc    微信appid
                timestamp : '<?php echo $wx_data['timestamp']; ?>', // 搜库资源网 soku.cc    时间戳
                nonceStr : '<?php echo $wx_data['nonceStr']; ?>',  // 搜库资源网 soku.cc    随机字符串
                signature : '<?php echo $wx_data['signature']; ?>', // 搜库资源网 soku.cc    签名
                jsApiList : [
                    // 搜库资源网 soku.cc    所有要调用的 API 都要加到这个列表中
                    'onMenuShareTimeline',       // 搜库资源网 soku.cc    分享到朋友圈接口
                    'onMenuShareAppMessage',  // 搜库资源网 soku.cc     分享到朋友接口
                    'onMenuShareQQ',         // 搜库资源网 soku.cc    分享到QQ接口
                    'onMenuShareWeibo'      // 搜库资源网 soku.cc    分享到微博接口
                ]
            });

            
            wx.ready (function () {
                // 搜库资源网 soku.cc    微信分享的数据
                var shareData = {
                    "imgUrl" : '<?php echo $post_data['imgUrl']; ?>',    // 搜库资源网 soku.cc    分享显示的缩略图地址
                    "link" : '<?php echo $post_data['link']; ?>',    // 搜库资源网 soku.cc    分享地址
                    "desc" : '<?php echo $post_data['desc']; ?>',   // 搜库资源网 soku.cc    分享描述
                    "title" :'<?php echo $post_data['title']; ?>',   // 搜库资源网 soku.cc    分享标题
                    success : function () {  
                        alert("分享成功"); 
                    } 
                };
